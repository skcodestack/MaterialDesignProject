...
public class NoInterceptonViewGroup extends FrameLayout {

    private static final String TAG = "NoInterceptonViewGroup";

    public NoInterceptonViewGroup(Context context) {
        super(context);
    }

    public NoInterceptonViewGroup(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public NoInterceptonViewGroup(Context context, AttributeSet attrs, int defStyleAttr) {
