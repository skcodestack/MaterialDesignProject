...
public class InterceptonViewGroup extends FrameLayout {

    private static final String TAG = "InterceptonViewGroup";

    public InterceptonViewGroup(Context context) {
        super(context);
    }

    public InterceptonViewGroup(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public InterceptonViewGroup(Context context, AttributeSet attrs, int defStyleAttr) {
