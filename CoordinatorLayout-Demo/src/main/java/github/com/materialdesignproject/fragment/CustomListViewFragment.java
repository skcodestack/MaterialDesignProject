...
public class CustomListViewFragment extends Fragment implements onLoadMoreListener, onRefreshListener {
    ...
    public static CustomListViewFragment newInstance() {
        CustomListViewFragment f = new CustomListViewFragment();
        return f;
    }
    ...
    private void initBase() {
        ...
        adapter = new CustomAdapter(refreshView.getContext(), list);
