...
public class CustomSwipeRecyclerViewFragment2 extends Fragment implements onLoadMoreListener, onRefreshListener {
    ...
    public static CustomSwipeRecyclerViewFragment2 newInstance() {
        CustomSwipeRecyclerViewFragment2 f = new CustomSwipeRecyclerViewFragment2();
        return f;
    }
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        rootView = inflater.inflate(R.layout.fragment_custom_swope2, container, false);
        initBase();
        return rootView;
    }
